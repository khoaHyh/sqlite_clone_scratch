...
// calculate sizes and offests for row serialization
...
// to serialize a row into memory
...
// to deserialize a row from memory
...
// to get the memory location for a specific row
